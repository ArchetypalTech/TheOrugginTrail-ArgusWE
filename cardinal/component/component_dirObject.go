...
type DirObject struct {
	...
	ObjType         int        `json:"obj_type"`   // The object type: door, window, etc. Use enums.DirObjectType
	DirType         int        `json:"dir_type"`   // The direction it is located: North, South, Up, etc. Use enums.DirectionType
	MatType         int        `json:"mat_type"`   // The material it is done with: iron, IKEA, etc. Use enums.MaterialType
